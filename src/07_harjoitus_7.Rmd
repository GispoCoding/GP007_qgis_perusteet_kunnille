...
Käynnistä QGIS-ohjelmisto. Avaa harjoituksen 4 QGIS-projekti ja tallenna se nimellä (**Projekti → Tallenna nimellä...**) "**QGIS_harjoitus_7**". Voit poistaa tai laittaa näkyvistä tasot TieViiva ja NaturaKohde_ma.
...
|                                  |                                                         |
|:-----------------:|:---------------------------------------------------:|
| ![](img/harjoitus_7/image16.png) |                Valitse/siirrä elementtiä                |
| ![](img/harjoitus_7/image21.png) | Siirrä elementin sisältöä (esimerkiksi kartan sisältöä) |
| ![](img/harjoitus_7/image19.png) |                 Zoomaa taiton näkymässä                 |

QGISin avulla voit muokata karttatulosteesi ulkoasua. Otsikko tai muu teksti voidaan lisätä **Lisää uusi nimiö** -työkalulla: ![](img/harjoitus_7/image7.png)

Lisää uusi selite käyttäen: ![](img/harjoitus_7/image8.png)

Ja lisää uusi mittakaava käyttäen: ![](img/harjoitus_7/image20.png)
...
![](img/harjoitus_7/image25.png)

Voit myös muokata selitteen ominaisuuksia. Huomaa, että sinun on poistettava kohdan **Päivitä automaattisesti** rasti. Pohjoisnuolen lisääminen tapahtuu lisäämällä kuva tällä työkalulla (vasemmasta palkista): ![](img/harjoitus_7/image14.png)
...
Varmista, että karttakomponentti on valittuna, valitse se **Valitse/Siirrä elementti -työkalulla** vasemmasta työpalkista ja klikkaamalla kartta aktiiviseksi: ![](img/harjoitus_7/image16.png)
