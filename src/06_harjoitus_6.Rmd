...
![](img/harjoitus_6/Suorakulmaisen_polygonin_piirt%C3%A4minen.gif)
...
1.  Lisää kurssihakemistostasi kiinteistörajat sisältävä vektoritaso **MML_Kiinteistörekisteri_03-2023_L4141H_kiinteisoraja.mif**

2.  Valitse **Rakennukset** taso aktiiviseksi.

3.  Laita **editointi** päälle ![](img/harjoitus_6/toggle_editing.png){width="26" height="24"} **Rakennukset**- tasolle,  **monikulmiokohteen piirtäminen päälle** ![](img/harjoitus_6/monikulmio_kohde.png) sekä l**aajennetun digitoinnin työkalut** aktiivisiksi ![](img/harjoitus_6/image15.png){width="26" height="24"}.

4.  **Laita laajennetun digitoinnin** paneelista (vasen reuna) **rakentamistila** päälle ![](img/harjoitus_6/image19.png) (tai painamalla **C**).
...
8.  Aloita piirtäminen poistamalla **rakentamistila** käytöstä ![](img/harjoitus_6/image19.png) (tai painamalla **C**).
...
13. Paina lopuksi hiiren oikeaa näppäintä, jolloin alue sulkeutuu. Rakennus on valmis.
...
1.  Lisää **MML_Kiinteistörekisteri_03-2023_L4141H_palsta.mif** taso (jatkossa "lähtötaso").

2.  Valitse polygoni/palsta, jonka haluat kopioida **valintatyökalulla** ![]()![](img/harjoitus_6/valintatyokalu.png).

3.  Kopioi polygoni leikepöydälle näppäinkomennolla **CTRL+C** tai (tai painamalla hiirellä valikosta **Kopioi kohteet** ![](img/harjoitus_6/kopioi_kohteet.png)).

4.  Jos haluat luoda kopion eri tasolle kuin millä alkuperäinen polygoni on, valitse kohdetaso tasopaneelista ja laita se **editointitilaan** ![](img/harjoitus_6/toggle_editing.png).

5.  Liitä kopio tasolle painamalla **CTRL+V** tai valikosta **Liitä kohteet** ![](img/harjoitus_6/liita_kohteet.png).
...
8.  Valitse Advanced Digitizing -valikosta **"Tee yhdensuuntaissiirtymä"** -työkalu (Offset curve) ![](img/harjoitus_6/offset_curve.png).
...
![](img/harjoitus_6/Polygonin_kopiointi_koon_muuttaminen.gif)Ja sitten ei kun harjoittelemaan käyttöä! Esitellyt työkalut voivat tuntua hankalilta ensialkuun, mutta jo pienelläkin harjoituksella ja toistoilla käytännöt tulevat tutuksi ja työskentely jouhevoituu.
